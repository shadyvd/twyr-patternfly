...
module.exports = function(deployTarget) {
  var ENV = {
    ...
    redis: {
      allowOverwrite: true,
      keyPrefix: 'twyr-patternfly:index'
    },
    s3: {
      prefix: 'twyr-patternfly'
    }
  };
  ...
  if (deployTarget === 'qa' || deployTarget === 'prod') {
    ...
    ENV.s3.bucket = process.env.AWS_S3_BUCKET_NAME /* YOUR S3 BUCKET NAME */;
    ENV.s3.region = process.env.AWS_S3_REGION /* YOUR S3 REGION */;
  }
